...
async function readJsonResponse(response: Response) {
  ...
  if (!contentType?.includes("application/json")) {
    ...
    throw new Error(
      "API returned HTML instead of JSON. Check /api/officer/documents/[documentId] route path."
    );
  }
...
export default function OfficerDocumentDetailPage() {
  ...
  const documentId = useMemo(() => {
    const fromParams = safeText(params.documentId || params.id);
    ...
    return safeText(lastSegment);
  }, [params.documentId, params.id, pathname]);
