  ...
  return (
    <>
      <button
        ...
        className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-[#d9c8b8] bg-[#fbf7ef] text-[#9b6f45] shadow-sm transition hover:bg-white lg:hidden"
      ...
      >
        ...
        <aside
          className={`dashboard-no-scrollbar absolute left-0 top-0 h-full w-[86%] max-w-[340px] overflow-y-auto overflow-x-hidden border-r border-[#d8ad80]/18 bg-[#211b17] p-5 text-white shadow-[25px_0_100px_rgba(0,0,0,0.55)] transition-transform duration-300 ease-out ${
